...
class RelationCreateView extends React.Component{
    constructor(props){
        super(props)
    }
    ...
    render(){
        let self =this
        let {viewData,cmmHost,app,model,viewType}= self.props
...
export default hookView.withHook(withRouter(connect(mapStateToProps)(RelationCreateView)))
